...
class Controller_Todo extends Controller
{
  ...
  { 
    ...
    $data = $model->paginatorData(PAGINATION_COUNT , $currentPage, $order);
    $count = $model->getCount();
    $count = ceil($count/PAGINATION_COUNT);
    $pages = range(1,$count);
    $this->view->generate('index_todo_view.php', 'template_view.php', $data, $pages);
  }
